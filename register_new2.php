<?php
  ...
  $db=mysqli_connect('localhost', 'phpmyadmin', 'password', 'MinHomeAutomation') or die ("failed to connect" .mysql_error());
		echo "Connected";
  ...
  try
  {
    ...
    if (!valid_email($email))
    {
      throw new Exception('That is not a valid email address.  Please go back '
                          .' and try again.');
	  do_html_url('register_form.php', 'Back');
    } 
   ...
   // register($username, $email, $passwd);
    ...
    echo 'Your registration was successful.  Go to the Dashboard page '
          .'to start setting up your system!';
    do_html_url('member.php', 'Go to Dashboard');
